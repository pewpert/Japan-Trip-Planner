...
import { MapPin, Bike, AlertTriangle, Coffee, Printer } from "lucide-react";
...
export function SummaryTab() {
  const { itinerary, route, costBreakdown, settings, suggestedBreaks, origin, destination, waypoints } = useTripStore();
